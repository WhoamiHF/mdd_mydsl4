 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.TeamDefinitionImpl#getRobots <em>Robots</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TeamDefinitionImpl extends Team_goal_or_taskImpl implements TeamDefinition
{
  ...
  {
    return MyDslPackage.Literals.TEAM_DEFINITION;
  }
  ...
  public EList<RobotDefinition> getRobots()
  {
    if (robots == null)
    {
      robots = new EObjectContainmentEList<RobotDefinition>(RobotDefinition.class, this, MyDslPackage.TEAM_DEFINITION__ROBOTS);
    }
    return robots;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.TEAM_DEFINITION__ROBOTS:
