 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.ModelImpl#getStatements <em>Statements</em>}</li>
 *   <li>{@link org.xtext.example.mydsl4.myDsl.impl.ModelImpl#getSimulate <em>Simulate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  public EList<Team_goal_or_task> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Team_goal_or_task>(Team_goal_or_task.class, this, MyDslPackage.MODEL__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain basicSetSimulate(SimulateStatement newSimulate, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__SIMULATE, oldSimulate, newSimulate);
  ...
  public void setSimulate(SimulateStatement newSimulate)
  {
    if (newSimulate != simulate)
    {
      ...
      if (simulate != null)
        msgs = ((InternalEObject)simulate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__SIMULATE, null, msgs);
      if (newSimulate != null)
        msgs = ((InternalEObject)newSimulate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.MODEL__SIMULATE, null, msgs);
      msgs = basicSetSimulate(newSimulate, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.MODEL__SIMULATE, newSimulate, newSimulate));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.MODEL__SIMULATE:
